...
public class RtoServiceMgmtImpl implements RtoServiceMgmt {
	...
	public Optional<VehicleOwnerRegistrationEntity> getbyId(Integer vehicleOwn) {
		...
		/*
		 * Optional<VehicleOwnerRegistrationEntity> list =
		 * OwnerDtlsRepo.findById(vownerEntity.getOid()); VehicleOwnerRegistrationEntity
		 * vownerDtls =list.get(); System.out.println(vownerDtls); return vownerDtls;
		 */
		
		
		
		return OwnerDtlsRepo.findById(vownerEntity.getOid());
	}

	@Override
	public Optional<VehicleDetailsEntity> getVehicleById(Integer vihcleOwnEntity) {
		
	 return vehicleDtlsRepo.findById(vownerEntity.getOid());
	...
	public Optional<OwnerAddressEntity> getownerId(Integer vehicleOwnEntity) {
		Optional<OwnerAddressEntity> list = ownerAddRepo.findById(vownerEntity.getOid());
